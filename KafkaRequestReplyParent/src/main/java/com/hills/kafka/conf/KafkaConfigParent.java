...
import com.hills.kafka.controller.VehicleController;
...
public class KafkaConfigParent {
  ...
  @Bean
  public ProducerFactory<String, Vehicle> replyProducerFactory() {
    return new DefaultKafkaProducerFactory<>(producerConfigs());
  }

  @Bean
  public KafkaTemplate<String, Vehicle> replyTemplate() {
