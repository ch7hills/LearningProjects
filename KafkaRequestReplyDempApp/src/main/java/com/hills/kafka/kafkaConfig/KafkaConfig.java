...
public class KafkaConfig {
	...
	@Value("${kafka.topic.vehicle.reply}")
	...
	@Bean
	public CompletableFutureReplyingKafkaOperations<String, String, Vehicle> replyKafkaTemplate() {
		CompletableFutureReplyingKafkaTemplate<String, String, Vehicle> requestReplyKafkaTemplate = new CompletableFutureReplyingKafkaTemplate<>(
	...
	@Bean
	public ConsumerFactory<String, Vehicle> replyConsumerFactory() {
		JsonDeserializer<Vehicle> jsonDeserializer = new JsonDeserializer<>();
		jsonDeserializer.addTrustedPackages("com.hills.kafka.models");
		return new DefaultKafkaConsumerFactory<>(consumerConfigs(), new StringDeserializer(), jsonDeserializer);
	}

	@Bean
	public KafkaMessageListenerContainer<String, Vehicle> replyListenerContainer() {
